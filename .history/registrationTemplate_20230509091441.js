...
// templates
  ...
  function updateRegTemplate(filteredArr = []) {
    ...
    const selectedTown = localStorage.setItem("selectedTown", townDataElemTemp.value);
    const showFilterMessageAndImage = selectedTown && selectedTown !== "Select Town" && filteredArr === 0 

    const registrationData = {
      differentReg: filteredArr,
      filterMessage: showFilterMessageAndImage ? regInstanceTemp.filterMessage() : "",
      filterImage:
        showFilterMessageAndImage
