...
function appendRegToNumberList_temp(regNumber) {
  ...
  newLi.innerHTML = updateRegTemplate(regNumber);
...
function updateRegTemplate(input) {
  ...
  const registrationData = {
    differentReg: [{ reg: input ? document.classList.add("number_display") : document.classList.remove("number_display") , filterMessage: regInstanceTemp.filteredMessage(), filterImage: '<img src="./images/not_found.svg" width="200"/>' }],
  };
