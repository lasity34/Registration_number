...
function updateRegTemplate(input) {
  ...
  const registrationData = {
    differentReg: [{ reg: input ? regList.classList.add("number_display") : regList.classList.remove("number_display") , filterMessage: regInstanceTemp.filteredMessage(), filterImage: '<img src="./images/not_found.svg" width="200"/>' }],
  };
